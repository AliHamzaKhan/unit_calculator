...
class _BMICalculatorState extends State<BMICalculator> {
  ...
  cmToFoot(double cm){
   return cm.convertFromTo(LENGTH.feet, LENGTH.centimeters);
  }
  kgToLbs(double kg){
    // return kg *0.453592;
    return kg * 2.204623;
                ...
                Row(
                  children: [
                    DropdownButton<String>(
                      ...
                      iconSize: 15,
                      value: _height,
                      items: <String>['cm', 'ft'].map((String value) {
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration:  InputDecoration(
                            labelText: 'Height ($_height)',
                            suffixText: _height == 'cm'? 'Centimeters' : 'Feet'
                        ),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          labelText: 'Weight ($_weight)',
                          suffixText:_weight == 'kg' ? 'Kilograms' : 'Pounds',
                        ),
                      ),
                    ),
                  ],
