...
import '../../../designs/custom_button.dart';
import '../controller/standard_controller.dart';
...
class _StandardScreenState extends State<StandardScreen> {
  ...
  var controller = Get.put(StandardController());
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ThemeModel themeNotifier, child){
      return Scaffold(
        ...
        body: Column(
          children: [
            GetBuilder<StandardController>(builder: (context) {
              return Expanded(
                child: Column(
